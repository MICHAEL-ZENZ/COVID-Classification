...
def resnet34(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _prunnableresenet('resnet34', prunnableBasicBlock, [3, 4, 6, 3], pretrained, progress,
                   **kwargs)
...
def resnet101(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _prunnableresenet('resnet101', prunnableBottleneck, [3, 4, 23, 3], pretrained, progress,
                   **kwargs)
...
def resnet152(pretrained=False, progress=True, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _prunnableresenet('resnet152', prunnableBottleneck, [3, 8, 36, 3], pretrained, progress,
                   **kwargs)
...
def resnext50_32x4d(pretrained=False, progress=True, **kwargs):
    ...
    return _prunnableresenet('resnext50_32x4d', prunnableBottleneck, [3, 4, 6, 3],
...
def resnext101_32x8d(pretrained=False, progress=True, **kwargs):
    ...
    return _prunnableresenet('resnext101_32x8d', prunnableBottleneck, [3, 4, 23, 3],
                   pretrained, progress, **kwargs)
...
def wide_resnet50_2(pretrained=False, progress=True, **kwargs):
    ...
    return _prunnableresenet('wide_resnet50_2', prunnableBottleneck, [3, 4, 6, 3],
                   pretrained, progress, **kwargs)
...
def wide_resnet101_2(pretrained=False, progress=True, **kwargs):
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _prunnableresenet('wide_resnet101_2', prunnableBottleneck, [3, 4, 23, 3],
                   pretrained, progress, **kwargs)
